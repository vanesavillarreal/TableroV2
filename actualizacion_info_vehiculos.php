...
$sql="update juridico set aniomes=left(fechaproxima,7)";
...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <?php 
                $query = "select * from vehiculos order by id";
                        ...
                        <div class="card row my-4">
                            <div class="card-header row" >
                                ...
                                <div class="col-sm-4" style="padding-right:0px;">
                                    <button class="btn btn-primary float-end" style="color:white;">
                                        <a href="nuevovehiculo.php">Nuevo Vehículo</a>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                <a href="editarvehiculo.php?id=<?php echo $row["id"] ?>"><span style="color:#13678A;"><i class="fa-sharp fa-solid fa-pencil"></i></span></a>&nbsp;&nbsp;
							                    <a href="eliminarvehiculo.php?id=<?php echo $row["id"] ?>"><span style="color:#BD2A2E;"><i class="fa-sharp fa-solid fa-trash"></i></span></a>
                                            </td>
