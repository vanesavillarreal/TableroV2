                            ...
                            <div class="col-sm-12">
                                <div class="card mb-4">
                                    ...
                                    <?php 
                                        ...
                                        $xml_estatus28="<chart bgalpha='0' showalternatevgridcolor='0' borderalpha='20' canvasborderalpha='0' theme='fint' useplotgradientcolor='0' plotborderalpha='10' placevaluesinside='1' captionpadding='20' showaxislines='1' axislinealpha='25' divlinealpha='10' yAxisMaxValue='100' >";
                                        $ultimo_dia = end($fechas);
                                        $sql = "SELECT DAY(fecha) as dia, cant_tickets_diarios
                                        FROM restaurante
                                        ...
                                        $result = mysqli_query($mysqli,$sql);
                                                while($row = mysqli_fetch_assoc($result))
                                                    {
                                                        $day = $row["dia"];
                                                        $cant_tickets = $row["cant_tickets_diarios"];
                                                        $xml_estatus28 = $xml_estatus28 . "<set label='$day' value='$cant_tickets' />";
                                                    }
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                ...
                                                $sql = "SELECT DAY(fecha) AS dia, ingresos_diarios
                                                FROM restaurante
                                                WHERE fecha BETWEEN '$fechas[0]' AND '$ultimo_dia'";
                                                $result = mysqli_query($mysqli,$sql);
                                                    while($row = mysqli_fetch_assoc($result))
                                                    {
                                                        $day = $row["dia"];
                                                        $ingresos = $row["ingresos_diarios"];
                                                        $xml_estatusq = $xml_estatusq . "<set label='$day' value='$ingresos' />";
                                                    }
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                ...
                                                $xml_estatusds="<chart caption='' bgalpha='0' showalternatevgridcolor='0' borderalpha='20' canvasborderalpha='0' theme='fint' useplotgradientcolor='0' plotborderalpha='10' placevaluesinside='1' captionpadding='20' showaxislines='1' axislinealpha='25' divlinealpha='10' yAxisMaxValue='100' numberprefix='$' >";

                                                $sql = "SELECT DAY(fecha) AS dia, promedio_ticket_diario
                                                        FROM restaurante
                                                        WHERE fecha BETWEEN '$fechas[0]' AND '$ultimo_dia'";
                                                $result = mysqli_query($mysqli,$sql);
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    $day = $row["dia"];
                                                    $porcetajeDeOcupacion = $row["promedio_ticket_diario"];
                                                    $xml_estatusds = $xml_estatusds . "<set label='$day' value='$porcetajeDeOcupacion' />";
                                                }
