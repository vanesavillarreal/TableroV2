...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav_nav">
            ...
            <?php 
                $query = "select * from vehiculos where id='".$_GET['id']."'";
                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="card my-4">
                            ...
                            <div class="card-body">
                                <form name="form1" method="post" action="modificarvehiculo.php">
                                    <table>
                                        <tbody>
                                                ...
                                                <tr><td colspan="3" style="padding-top: 1em;"><input type="submit" class="btn btn-success float-start" value="Guardar"><button class="btn btn-danger float-end"><a href="actualizacion_info_vehiculos.php">Cancelar</a></button></td></tr>
                                        </tbody>
                                    </table>
                                </form>
                            </div>
