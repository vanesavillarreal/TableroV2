                            ...
                            <div class="card-header row" >
                                ...
                                <div class="col-sm-4" style="padding-right:0px;">
                                    <button class="btn btn-primary float-end" style="color:white;">
                                        <a href="nuevapropiedad.php">Nueva Propiedad</a>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align: center">
                                                <a href="editarpropiedad.php?id=<?php echo $row["id"] ?>"><span style="color:#13678A;"><i class="fa-sharp fa-solid fa-pencil"></i></span></a>&nbsp;&nbsp;
							                    <a href="eliminarpropiedad.php?id=<?php echo $row["id"] ?>"><span style="color:#BD2A2E;"><i class="fa-sharp fa-solid fa-trash"></i></span></a>
                                            </td>
