...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav_nav">
            ...
            <?php 
                $query = "select * from juridico where id='".$_GET['id']."'";
                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="card my-4">
                            ...
                            <div class="card-body">
                                <form name="form1" method="post" action="modificardemanda.php">
                                    <table>
                                        <tbody>
                                                <input type="hidden" name="id" value="<?php echo $_GET["id"] ?>">
                                                <tr><td><strong>Empresa</strong></td><td><input type="text" class="form-control input-sw" name="empresa" value="<?php echo $empresa ?>" required></td></tr>
                                                <tr><td><strong>Tipo de demanda</strong></td><td><input type="text" class="form-control input-sw" name="tipodemanda" value="<?php echo $tipodemanda ?>" required></td></tr>
                                                <tr><td><strong>Fecha de presentación</strong></td><td><input type="date" class="form-control input-sw" name="fechapresentacion" value="<?php echo $fechapresentacion ?>" required></td></tr>
                                                <tr><td><strong>Folio</strong></td><td><input type="text" class="form-control input-sw" name="folio" value="<?php echo $folio ?>" required></td></tr>
                                                <tr><td><strong>Demandado</strong></td><td><input type="text" class="form-control input-sw" name="demandado" value="<?php echo $demandado ?>" required></td></tr>
                                                <tr><td><strong>Demandante</strong></td><td><input type="text" class="form-control input-sw" name="demandante" value="<?php echo $demandante ?>" required></td></tr>
                                                <tr><td><strong>Asignado a</strong></td><td><input type="text" class="form-control input-sw" name="asignadoa" value="<?php echo $asignadoa ?>" required></td></tr>
                                                <tr><td><strong>Fecha previa de presentación</strong></td><td><input type="date" class="form-control input-sw" name="fechaprevia" value="<?php echo $fechaprevia ?>" ></td></tr>
                                                <tr><td><strong>Fecha de próxima audiencia</strong></td><td><input type="date" class="form-control input-sw" name="fechaproxima" value="<?php echo $fechaproxima ?>" ></td></tr>
                                                <tr><td width="135"><strong>Estatus</strong></td><td colspan="2">
                                                    <select class="form-control input-sm" name="estatus">
                                                        <option value=""></option>
                                                        <option value="Nueva" <?php if($estatus=="Nueva")?>>Nueva</option>
                                                        <option value="En proceso" <?php if($estatus=="En proceso")echo "selected"?>>En proceso</option>
                                                        <option value="Contrademanda" <?php if($estatus=="Contrademanda")echo "selected"?>>Contrademanda</option>
                                                        <option value="Fallo a favor" <?php if($estatus=="Fallo a favor")echo "selected"?>>Fallo a favor</option>
                                                        <option value="Fallo en contra" <?php if($estatus=="Fallo en contra")echo "selected"?>>Fallo en contra</option>
                                                    </select>
                                                </td></tr>
                                                <tr><td><strong>Observaciones</strong></td><td><textarea rows="4" class="form-control input-sw" name="observaciones" required><?php echo $observaciones ?></textarea></td></tr>

                                                <tr><td colspan="3" style="padding-top: 1em;"><input type="submit" class="btn btn-success float-start" value="Guardar"><button class="btn btn-danger float-end"><a href="actualizacion_info.php">Cancelar</a></button></td></tr>
                                        </tbody>
                                    </table>
                                </form>
                            </div>
